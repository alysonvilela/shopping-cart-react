...
const cartQuantity = cart.length
    return (
      <header class="text-secondary-11 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-row items-center justify-between">
          <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            ...
            <span class="ml-3 text-xl text-secondary-12">CartApp</span>
          </a>
          <nav class="hidden sm:flex flex-wrap items-center text-base justify-center">
            <a class="mr-5 hover:text-secondary-12">
              <Link to="/">Home</Link>
            </a>
            <a class="mr-5 hover:text-secondary-12">
          ...
          <button onClick={() => navigate('/cart')} class="inline-flex items-center bg-primary-11 text-primary-3 border-0 py-3 px-5 focus:outline-none hover:bg-primary-10 rounded text-base mt-0">
